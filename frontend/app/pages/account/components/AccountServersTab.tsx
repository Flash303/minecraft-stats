    ...
    return (
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="text-center py-20 border-2 border-dashed rounded-2xl bg-muted/30 flex flex-col items-center justify-center">
                    <ServerIcon className="h-12 w-12 text-muted-foreground/30 mb-4" />
                    <h3 className="text-lg font-bold text-foreground">{t("profile.servers.noServersTitle")}</h3>
                    <p className="text-muted-foreground mt-1 max-w-sm">{t("profile.servers.noServersDescription")}</p>
                </div>
            ) : filteredServers.length === 0 ? (
                <div className="text-center py-16 border-2 border-dashed rounded-2xl bg-muted/30 flex flex-col items-center justify-center px-4">
