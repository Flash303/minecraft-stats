...
export function AccountServerCard({ server, onSuccess }: AccountServerCardProps) {
    return (
        <div className="relative group">
            ...
            <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity z-10 bg-background/95 backdrop-blur-md rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-0.5">
