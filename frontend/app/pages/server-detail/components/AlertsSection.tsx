                ...
                <div className="flex flex-col gap-4">
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col gap-2.5">
                            {alerts.map((alert) => (
                                <div key={alert.id} className="group flex items-center justify-between p-3.5 bg-slate-50/50 dark:bg-slate-800/40 rounded-lg border border-border/80 transition-colors hover:bg-slate-100/50 dark:hover:bg-slate-800/60">
                                    <div className="flex flex-col">
                                        ...
                                        {(alert.alert_type === "player_above" || alert.alert_type === "player_below") && (
                                            <span className="text-xs text-muted-foreground mt-1">
                                                {t("alerts.thresholdLabel")} : <strong className="text-foreground font-medium px-1.5 py-0.5 bg-slate-200/50 dark:bg-slate-700/50 rounded">{alert.player_threshold}</strong>
                                            </span>
                                        )}
                                    </div>
                                    <Button 
